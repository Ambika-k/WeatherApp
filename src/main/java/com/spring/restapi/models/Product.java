 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @Document(collection = "productdb") public class Product implements
		 * Serializable {
		 * 
		 * private static final long serialVersionUID = 5604944562275121069L;
		 * 
		 * @Id private String id; private String product; private String productType;
		 * private String description;
		 * 
		 * public Product( String product,String productType, String description) {
		 * 
		 * this.product = product; this.description = description; this.productType =
		 * productType; }
		 * 
